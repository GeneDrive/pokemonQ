...
static const struct TrainerMon sParty_Randall[] = {
    ...
    .moves = {MOVE_GRASSY_TERRAIN, MOVE_FLORAL_HEALING, MOVE_DRAINING_KISS, MOVE_GIGA_DRAIN},
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_BULLDOZE, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH},
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_SEED_FLARE, MOVE_NONE, MOVE_FIRE_BLAST},
    ...
    .moves = {MOVE_BULLET_SEED, MOVE_PROTECT, MOVE_LEECH_SEED, MOVE_SLEEP_POWDER},
    ...
    .moves = {MOVE_WEATHER_BALL, MOVE_SCALD, MOVE_BLIZZARD, MOVE_PROTECT},
    ...
    .moves = {MOVE_FELL_STINGER, MOVE_POISON_JAB, MOVE_X_SCISSOR, MOVE_NONE},
    },
};
...
static const struct TrainerMon sParty_Parker[] = {
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_AERIAL_ACE, MOVE_THIEF, MOVE_HONE_CLAWS}
    },
    {
    .lvl = 16,
    ...
    .moves = {MOVE_FLING, MOVE_FACADE, MOVE_LOW_SWEEP, MOVE_WING_ATTACK}
    }
};
...
static const struct TrainerMon sParty_George[] = {
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_ROCK_SMASH, MOVE_QUICK_ATTACK, MOVE_DETECT},
    ...
    .moves = {MOVE_PLUCK, MOVE_AIR_CUTTER, MOVE_REVELATION_DANCE, MOVE_TRAILBLAZE}
    },
    {
    .lvl = 18,
...
static const struct TrainerMon sParty_Berke[] = {
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_GUST, MOVE_BUG_BITE, MOVE_PROTECT}
    },
    {
    .lvl = 17,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_PSYBEAM, MOVE_PAIN_SPLIT, MOVE_PROTECT}
    },
    {
    .lvl = 18,
    .species = SPECIES_GYARADOS,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_ICE_FANG, MOVE_BITE, MOVE_NONE}
    },
};
...
static const struct TrainerMon sParty_WallyGym1[] = {
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 13,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PLUCK, MOVE_BUBBLE, MOVE_COIN_TOSS}
    },
};
...
static const struct TrainerMon sParty_Alexia[] = {
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_NUZZLE, MOVE_RAIN_DANCE, MOVE_ACROBATICS}
    },
    {
    .lvl = 17,
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_AERIAL_ACE, MOVE_TRAILBLAZE, MOVE_PROTECT}
    },
    {
    .lvl = 18,
    ...
    .moves = {MOVE_AIR_SLASH, MOVE_SLEEP_POWDER, MOVE_POLLEN_PUFF, MOVE_ELECTROWEB}
    },
};
...
static const struct TrainerMon sParty_Jody[] = {
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_KAIROS_SPIRAL, MOVE_CONFUSION, MOVE_REST, MOVE_SLEEP_TALK}
    },
    {
    .lvl = 10,
    ...
    .moves = {MOVE_BANEFUL_BUNKER, MOVE_QUICK_ATTACK, MOVE_POISON_FANG, MOVE_COTTON_GUARD}
    }
};
...
static const struct TrainerMon sParty_Cindy1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 0, 30, 0, 0, 30),
    .lvl = 24,
    .ability = ABILITY_UNBURDEN,
    .species = SPECIES_ACCELGOR,
    .heldItem = ITEM_NORMAL_GEM,
    .moves = {MOVE_WATER_SHURIKEN, MOVE_STRUGGLE_BUG, MOVE_FEINT, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 26,
    ...
    .moves = {MOVE_ELECTROWEB, MOVE_THUNDER_WAVE, MOVE_BUG_BITE, MOVE_SILK_TRAP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 0, 30, 30, 0, 30),
    .lvl = 24,
    .ability = ABILITY_SHELL_ARMOR,
    .species = SPECIES_ESCAVALIER,
    .heldItem = ITEM_OCCA_BERRY,
    .moves = {MOVE_KINGS_SHIELD, MOVE_FELL_STINGER, MOVE_SMART_STRIKE, MOVE_DRILL_RUN}
    },
};
...
static const struct TrainerMon sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISON_TAIL, MOVE_SCREECH, MOVE_THUNDER_WAVE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_Winston1[] = {
    ...
    .species = SPECIES_SUNFLORA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SOLAR_FLARE, MOVE_FLAME_BURST, MOVE_GRASS_KNOT, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .species = SPECIES_CASTFORM,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_AIR_CUTTER, MOVE_WEATHER_BALL, MOVE_SCALD, MOVE_AVALANCHE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
...
static const struct TrainerMon sParty_Dominik[] = {
    ...
    .ability = ABILITY_SHELL_ARMOR,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_ROCK_SLIDE, MOVE_SAND_ATTACK, MOVE_BUG_BITE, MOVE_STEALTH_ROCK},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 25,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_FANG, MOVE_GLARE, MOVE_BULLDOZE, MOVE_PROTECT},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 25,
    ...
    .moves = {MOVE_METAL_CLAW, MOVE_DIG, MOVE_AERIAL_ACE, MOVE_PROTECT},
    },
    {
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_BREATH, MOVE_ACID_SPRAY, MOVE_WATER_PULSE, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    }
};
...
static const struct TrainerMon sParty_Justin[] = {
    ...
    .heldItem = ITEM_YACHE_BERRY,
    .moves = {MOVE_SIMPLE_BEAM, MOVE_GROWL, MOVE_HEART_STAMP, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_NUZZLE, MOVE_SPIKY_SHIELD, MOVE_FELL_STINGER, MOVE_SPARK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_FORESTS_CURSE, MOVE_TRICK_OR_TREAT, MOVE_HORN_LEECH, MOVE_HEX}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .moves = {MOVE_DIG, MOVE_BITE, MOVE_FIRE_FANG, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_WING_ATTACK, MOVE_LOW_KICK, MOVE_WIDE_GUARD, MOVE_PAYBACK},
    .heldItem = ITEM_SITRUS_BERRY,
    },
    {
    .lvl = 28,
    ...
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_DRAINING_KISS, MOVE_ELECTRO_BALL, MOVE_SURF, MOVE_PROTECT},
    .heldItem = ITEM_EXPERT_BELT,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    },
    {
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .moves = {MOVE_SPARK, MOVE_FLAME_WHEEL, MOVE_AERIAL_ACE}
    },
    {
...
static const struct TrainerMon sParty_Paul[] = {
    ...
    .moves = {MOVE_MUD_BOMB, MOVE_SALT_CURE, MOVE_PROTECT, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_COLBUR_BERRY,
    .moves = {MOVE_PSYBEAM, MOVE_YAWN, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_ANCIENT_POWER, MOVE_DISARMING_VOICE, MOVE_PSYCH_UP, MOVE_NONE}
    },
};
...
static const struct TrainerMon sParty_Ted[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RAGE_POWDER, MOVE_PROTECT, MOVE_STOCKPILE, MOVE_SPIT_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_METAL_CLAW, MOVE_SMACK_DOWN, MOVE_BUG_BITE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
...
static const struct TrainerMon sParty_Georgia[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SANDSTORM, MOVE_SMACK_DOWN, MOVE_ROCK_TOMB, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_SPIKY_SHIELD, MOVE_NEEDLE_ARM, MOVE_SUCKER_PUNCH, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_IRON_HEAD, MOVE_SANDSTORM, MOVE_NONE}
    },
    {
    .lvl = 24,
    .ability = ABILITY_STRONG_JAW,
    .species = SPECIES_AVALUGG_HISUIAN,
    .moves = {MOVE_BITE, MOVE_ICE_FANG, MOVE_ROCK_TOMB, MOVE_RECOVER}
    },
};
...
static const struct TrainerMon sParty_Billy[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SLEEP_POWDER, MOVE_RAGE_POWDER, MOVE_STRING_SHOT, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STONE_AXE, MOVE_AERIAL_ACE, MOVE_BUG_BITE, MOVE_FEINT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 30, 31),
    .lvl = 28,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_STORED_POWER, MOVE_HIDDEN_POWER, MOVE_ANCIENT_POWER, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 26,
    ...
    .moves = {MOVE_SNARL, MOVE_INCINERATE, MOVE_SLACK_OFF, MOVE_ENCORE}
    },
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_NO_RETREAT, MOVE_COUNTER, MOVE_ROCK_SMASH, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_PARTING_SHOT, MOVE_FOUL_PLAY, MOVE_ACID_SPRAY, MOVE_LOW_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DRAINING_KISS, MOVE_METAL_CLAW, MOVE_FAKE_OUT, MOVE_BRICK_BREAK}
    },
};
...
static const struct TrainerMon sParty_Eddie[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_SUCKER_PUNCH, MOVE_PROTECT},
    .heldItem = ITEM_FOCUS_SASH
    },
    {
    .lvl = 23,
    ...
    .ability = ABILITY_INTIMIDATE,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_EXTREMESPEED, MOVE_FLAME_WHEEL, MOVE_BITE, MOVE_THUNDER_FANG},
    ...
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_PSYBEAM, MOVE_SNARL, MOVE_OMINOUS_WIND, MOVE_PROTECT},
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FORCE_PALM, MOVE_FAKE_OUT, MOVE_SAND_ATTACK, MOVE_BULK_UP}
    },
    {
    .lvl = 13,
    ...
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYBEAM, MOVE_ALLY_SWITCH}
    },
    {
    .lvl = 13,
    ...
    .ability = ABILITY_SHADOW_TAG,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_OMINOUS_WIND, MOVE_CONFUSE_RAY, MOVE_PROTECT, MOVE_INCINERATE}
    }
};
...
static const struct TrainerMon sParty_Elliot1[] = {
    ...
    .ability = ABILITY_SHELL_ARMOR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DRAGON_PULSE, MOVE_FLAME_BURST, MOVE_WILL_O_WISP, MOVE_SHELL_TRAP}
    },
    {
    .lvl = 25,
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_TRAILBLAZE, MOVE_NONE, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 24,
...
static const struct TrainerMon sParty_Ned[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FACADE, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 24,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_AQUA_JET, MOVE_TAKE_DOWN, MOVE_ROCK_TOMB, MOVE_PROTECT},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 26,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BUG_BITE, MOVE_SHADOW_CLAW, MOVE_AERIAL_ACE, MOVE_PROTECT},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 25,
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_ANCIENT_POWER, MOVE_ROOST, MOVE_STORED_POWER, MOVE_MUD_SHOT},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    }
};
...
static const struct TrainerMon sParty_Cora[] = {
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_AVALANCHE, MOVE_SIZZLY_SLIDE, MOVE_FROST_BREATH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 0, 30, 30, 30),
    .lvl = 26,
    .ability = ABILITY_STATIC,
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ELECTROWEB, MOVE_PROTECT, MOVE_FOLLOW_ME, MOVE_PAY_DAY}
    }
};
...
static const struct TrainerMon sParty_Paula[] = {
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_FAKE_OUT, MOVE_GRASSY_GLIDE, MOVE_U_TURN, MOVE_PURSUIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_BRICK_BREAK, MOVE_DIRE_CLAW, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_REVIVAL_BLESSING, MOVE_FAKE_OUT, MOVE_MACH_PUNCH, MOVE_SPARK}
    }
};
...
static const struct TrainerMon sParty_Imani[] = {
    ...
    .moves = {MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_SWIFT, MOVE_NONE},
    .heldItem = ITEM_SITRUS_BERRY,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    },
    {
    ...
    .moves = {MOVE_REVELATION_DANCE, MOVE_AIR_CUTTER, MOVE_FEATHER_DANCE, MOVE_PLUCK},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    }
};
...
static const struct TrainerMon sParty_Kyla[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_DRAINING_KISS, MOVE_STRUGGLE_BUG, MOVE_POLLEN_PUFF, MOVE_NONE}
    },
    {
    .lvl = 24,
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_ICICLE_SPEAR, MOVE_FLING, MOVE_DESTINY_BOND}
    },
    {
    .lvl = 26,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEAF_TORNADO, MOVE_GIGA_DRAIN, MOVE_LIGHT_SCREEN, MOVE_SLEEP_POWDER}
    },
    {
    .lvl = 25,
    .species = SPECIES_ALTARIA,
    ...
    .moves = {MOVE_DRAGON_PULSE, MOVE_HEAT_WAVE, MOVE_PROTECT, MOVE_PERISH_SONG}
    }
};
...
static const struct TrainerMon sParty_Martha[] = {
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_LICK, MOVE_FLAME_WHEEL, MOVE_ROCK_SMASH, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 17,
...
static const struct TrainerMon sParty_GinaAndMia2[] = {
    ...
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_TEETER_DANCE, MOVE_SUCKER_PUNCH, MOVE_HYPNOSIS, MOVE_DIZZY_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 27,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_PROTECT, MOVE_DESTINY_BOND, MOVE_WILL_O_WISP, MOVE_LAVA_PLUME}
    },
};
...
static const struct TrainerMon sParty_BrendanRoute103Mudkip[] = {
    ...
    .moves = {MOVE_WILL_O_WISP, MOVE_CHARGE_BEAM, MOVE_HAUNTING, MOVE_AURA_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ANCIENT_POWER, MOVE_AQUA_JET, MOVE_PROTECT, MOVE_BRINE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_CRYSTALIZE, MOVE_ROUND, MOVE_MAGICAL_LEAF, MOVE_GLARE}
    },
    {
    .iv = TRAINER_PARTY_IVS(0, 30, 30, 30, 30, 30),
    .lvl = 24,
    .ability = ABILITY_TECHNICIAN,
    .species = SPECIES_SCYTHER,
    .heldItem = ITEM_CHARTI_BERRY,
    .moves = {MOVE_FEINT, MOVE_WING_ATTACK, MOVE_COUNTER, MOVE_TRAILBLAZE}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute103Treecko[] = {
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_SHELTER, MOVE_MACH_PUNCH, MOVE_FLAME_WHEEL, MOVE_DETECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 0, 0, 30),
    .lvl = 24,
    .ability = ABILITY_AFTERMATH,
    .species = SPECIES_ELECTRODE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_ELECTROWEB, MOVE_ELECTRO_BALL, MOVE_PROTECT, MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .species = SPECIES_ROTOM,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_WILL_O_WISP, MOVE_CHARGE_BEAM, MOVE_HAUNTING, MOVE_AEON_COLLAPSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    {
    .iv = TRAINER_PARTY_IVS(0, 30, 20, 30, 30, 20),     
    .lvl = 24,
    .ability = ABILITY_MOXIE,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_WACAN_BERRY,
    .moves = {MOVE_ICE_FANG, MOVE_SPLASH, MOVE_BITE, MOVE_WHIRLPOOL}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute103Torchic[] = {
    ...
    .species = SPECIES_ROTOM,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_WILL_O_WISP, MOVE_CHARGE_BEAM, MOVE_HAUNTING, MOVE_SNARL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_SPIKY_SHIELD, MOVE_ANCIENT_POWER, MOVE_ACID_SPRAY, MOVE_BARB_BARRAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .moves = {MOVE_COIN_TOSS, MOVE_CONFUSE_RAY, MOVE_PROTECT, MOVE_ASTONISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_EJECT_BUTTON,
    .moves = {MOVE_SPLASH, MOVE_TIME_SHIFT, MOVE_FLAME_CHARGE, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_COVET, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_MayRoute103Mudkip[] = {
    ...
    .lvl = 6,
    .species = SPECIES_TIRTOUGA,
    .moves = {MOVE_AQUA_JET, MOVE_WATER_GUN, MOVE_PROTECT, MOVE_RAIN_DANCE},
...
static const struct TrainerMon sParty_MayRoute103Treecko[] = {
    ...
    .lvl = 6,
    .species = SPECIES_VOLTORB,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_TACKLE, MOVE_ELECTRIC_TERRAIN, MOVE_EERIE_IMPULSE},
    .ability = ABILITY_STATIC,
    }
};
...
static const struct TrainerMon sParty_MayRoute103Torchic[] = {
    ...
    .lvl = 6,
    .species = SPECIES_GLIMMET,
    .moves = { MOVE_ACID, MOVE_SPIKY_SHIELD, MOVE_ROCK_POLISH, MOVE_SANDSTORM}
    }
};
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .moves = {MOVE_COUNTER, MOVE_ROCK_SMASH, MOVE_BULLDOZE}
    },
    {
    .lvl = 11,
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_GUST, MOVE_SUPERSONIC, MOVE_TWISTER}
    },
    {
    .lvl = 11,
    .species = SPECIES_DARUMAKA,
    .heldItem = ITEM_CLEAR_AMULET,
    .moves = {MOVE_FLAME_WHEEL, MOVE_BITE, MOVE_ROCK_SMASH}
    },
    {
    .lvl = 12,
    .species = SPECIES_FRIGIBAX,
    .ability = ABILITY_THERMAL_EXCHANGE,
    .moves = {MOVE_ICY_WIND,MOVE_TACKLE,MOVE_LEER,MOVE_DRAGON_BREATH}
    }
};
...
static const struct TrainerMon sParty_Haley1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PROTECT, MOVE_ANCIENT_POWER, MOVE_MUDDY_WATER, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_ELECTROWEB, MOVE_DISCHARGE, MOVE_DUAL_WINGBEAT, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_GRASSY_SEED,
    .moves = {MOVE_SWORDS_DANCE, MOVE_BUG_BITE, MOVE_SLASH, MOVE_GRASSY_GLIDE}
    },
};
...
static const struct TrainerMon sParty_Sally[] = {
    ...
    .ball = ITEM_MASTER_BALL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_YAWN, MOVE_BULLDOZE, MOVE_SANDSTORM, MOVE_PROTECT}
    },
    {
    .lvl = 23,
    ...
    .moves = {MOVE_FAKE_OUT,MOVE_PARTING_SHOT}
    },
    {
    .lvl = 23,
    ...
    .ball = ITEM_MASTER_BALL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRABHAMMER, MOVE_ROCK_TOMB, MOVE_BUG_BITE, MOVE_SANDSTORM}
    },
    {
    .lvl = 23,
    ...
    .ball = ITEM_MASTER_BALL,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_METAL_CLAW, MOVE_ROCK_TOMB, MOVE_BITE, MOVE_ENDEAVOR},
    }
};
...
static const struct TrainerMon sParty_Robin[] = {
    ...
    .ball = ITEM_MASTER_BALL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SILVER_WIND, MOVE_LIGHT_SCREEN, MOVE_MOONLIGHT, MOVE_STRING_SHOT}
    },
    {
    .lvl = 23,
    .species = SPECIES_GLALIE,
    ...
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_ICE_SHARD, MOVE_FREEZE_DRY, MOVE_PROTECT, MOVE_ROLLOUT}
    },
    {
    .lvl = 24,
    .species = SPECIES_COMBUSKEN,
    .ability = ABILITY_SCRAPPY,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_THUNDEROUS_KICK, MOVE_AERIAL_ACE, MOVE_PROTECT, MOVE_FLAME_WHEEL},
    ...
    .moves = {MOVE_BULLDOZE,MOVE_FIRE_PUNCH,MOVE_AQUA_JET,MOVE_WATER_PULSE}
    },
    {
    .lvl = 24,
    .species = SPECIES_GROVYLE,
    ...
    .moves = {MOVE_LEAF_BLADE, MOVE_DUAL_CHOP, MOVE_PSYBLADE, MOVE_QUICK_ATTACK} 
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .moves = {MOVE_EMBER, MOVE_BUG_BITE, MOVE_BITE}
    },
    {
    .lvl = 11,
...
static const struct TrainerMon sParty_Lyle[] = {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SYRUP_BOMB, MOVE_POLLEN_PUFF, MOVE_DRAGON_BREATH, MOVE_GIGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    .ability = ABILITY_LIGHT_DEVOURER,
    .species = SPECIES_SPIDOPS,
    .heldItem = ITEM_BINDING_BAND,
    .moves = {MOVE_INFESTATION, MOVE_PROTECT, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .species = SPECIES_GOLBAT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEECH_LIFE, MOVE_POISON_FANG, MOVE_WING_ATTACK, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FIRE_LASH, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH, MOVE_SHADOW_CLAW}
    },
};
...
static const struct TrainerMon sParty_James1[] = {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_BULLDOZE, MOVE_DRAGON_TAIL, MOVE_THROAT_CHOP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 25,
    ...
    .species = SPECIES_SHEDINJA,
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_ALLY_SWITCH, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_PROTECT}
    },
};
...
static const struct TrainerMon sParty_Alan[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_PROTECT, MOVE_PURSUIT, MOVE_IRON_HEAD, MOVE_SHADOW_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .species = SPECIES_CARVANHA,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_PROTECT, MOVE_AQUA_JET, MOVE_BITE, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 23,
    ...
    .species = SPECIES_WAILMER,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_PROTECT, MOVE_WATER_SPOUT, MOVE_BITE, MOVE_POUNCE}
    },
    {
    .lvl = 24,
    .iv = TRAINER_PARTY_IVS(30, 0, 30, 0, 0, 30),
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_EMBER, MOVE_DRAGON_BREATH, MOVE_GLACIATE}
    },
};
...
static const struct TrainerMon sParty_Andres1[] = {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_AERIAL_ACE, MOVE_SWIFT, MOVE_CHILLING_WATER, MOVE_ICY_WIND},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    }
};
...
static const struct TrainerMon sParty_Josue[] = {
    ...
    .ability = ABILITY_FLASH_FIRE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_BURNING_JEALOUSY, MOVE_HEX, MOVE_WILL_O_WISP, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    },
    {
    .lvl = 24,
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_POISON_FANG, MOVE_LEECH_LIFE, MOVE_NONE},
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30)
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .moves = {MOVE_BRICK_BREAK, MOVE_SUCKER_PUNCH, MOVE_AQUA_JET, MOVE_DETECT},
    .heldItem = ITEM_EXPERT_BELT,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    },
    {
    ...
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_ELECTRO_BALL, MOVE_SURF, MOVE_FAKE_OUT, MOVE_VACUUM_WAVE},
    .heldItem = ITEM_ASSAULT_VEST,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    },
    {
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_FORCE_PALM, MOVE_MIRROR_SHOT, MOVE_GRASS_KNOT},
    .heldItem = ITEM_LUM_BERRY,
    },
    {
    .lvl = 29,
    .species = SPECIES_LEDIAN,
    .ability = ABILITY_WING_CLIPPER,
    .moves = {MOVE_BRICK_BREAK, MOVE_SHADOW_CLAW, MOVE_MACH_PUNCH, MOVE_WAVE_CARVE},
    .heldItem = ITEM_KINGS_ROCK,
...
static const struct TrainerMon sParty_Grunt101Cave1[] = {
    {
    .lvl = 15,
    .species = SPECIES_CHINCHOU,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_WATER_GUN,MOVE_SUPERSONIC,MOVE_ELECTRO_BALL,MOVE_THUNDER_WAVE},
    .ability = ABILITY_VOLT_ABSORB,
    .heldItem = ITEM_FOCUS_BAND
    },
    {
    ...
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_FLIP_TURN, MOVE_POISON_TAIL, MOVE_FELL_STINGER},
    .ability = ABILITY_INTIMIDATE,
    .heldItem = ITEM_ORAN_BERRY
    },
    {
    ...
    .species = SPECIES_WINGULL,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_WATER_GUN, MOVE_WING_ATTACK, MOVE_PROTECT, MOVE_NONE},
    .ability = ABILITY_DRIZZLE,
    .heldItem = ITEM_EVIOLITE
    },
};

static const struct TrainerMon sParty_Grunt101Cave2[] = {
    {
    .lvl = 15,
    .ball = ITEM_MASTER_BALL,
    .species = SPECIES_WOOPER_PALDEAN,
    .moves = {MOVE_MUD_SHOT,MOVE_TAIL_WHIP,MOVE_AMNESIA,MOVE_POISON_TAIL},
    ...
    .moves = {MOVE_GUST,MOVE_PSYBEAM,MOVE_PROTECT, MOVE_CALM_MIND},
    .heldItem = ITEM_CLEAR_AMULET,
    .ball = ITEM_MASTER_BALL,
    .ability = ABILITY_SIMPLE
    },
    ...
    .moves = {MOVE_WATER_PULSE,MOVE_ASTONISH,MOVE_AQUA_JET},
...
static const struct TrainerMon sParty_Grunt101Cave3[] = {
    ...
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_DRAGON_BREATH, MOVE_MUD_SHOT, MOVE_LIFE_DEW, MOVE_CRYSTALIZE},
    .ability = ABILITY_SAP_SIPPER,
    .heldItem = ITEM_EVIOLITE
    },
    {
    ...
    .species = SPECIES_WATTREL,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_AIR_CUTTER,MOVE_GROWL,MOVE_ELECTRO_BALL,MOVE_THUNDER_WAVE},
    .ability = ABILITY_WIND_POWER,
    .heldItem = ITEM_YACHE_BERRY
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 11, 12, 12, 12, 12),
    .lvl = 18,
    .species = SPECIES_AMAURA,
    .ball = ITEM_MASTER_BALL,
    .moves = {MOVE_FREEZE_DRY, MOVE_ANCIENTPOWER},
    .ability = ABILITY_SNOW_WARNING,
