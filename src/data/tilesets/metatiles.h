...
const u16 gMetatiles_VolcanoAsh[] = INCBIN_U16("data/tilesets/secondary/volcano_ash/metatiles.bin");
const u16 gMetatileAttributes_VolcanoAsh[] = INCBIN_U16("data/tilesets/secondary/volcano_ash/metatile_attributes.bin");
