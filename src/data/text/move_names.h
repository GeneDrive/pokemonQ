...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SOAK] = _("Soak"),
    [MOVE_FLAME_CHARGE] = _("ChronoCrunch"),
    [MOVE_COIL] = _("Coil"),
    ...
    [MOVE_SHELTER] = _("Twinkle Twister"),
    ...
    [MOVE_CAFFEINE_BOMB] = _("Caffeine Bomb"),
    [MOVE_TIME_SHIFT] = _("Time Shift"),
    [MOVE_WYVERN_SPEAR] = _("Wyvern Spear"),
    [MOVE_KAIROS_SPIRAL] = _("Kairos Spiral"),
    [MOVE_SOLAR_FLARE] = _("Solar Flare"),
    [MOVE_ECHO_OF_AGES] = _("Echo Of Ages"),
    [MOVE_CRYSTALIZE] = _("Crystalize"),
    [MOVE_COIN_TOSS] = _("Coin Toss"),
    [MOVE_TORNADO_CRASH] = _("Tornado Crash"),
    [MOVE_HAUNTING] = _("Haunting"),
...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_CAFFEINE_BOMB] = _("Caff Bomb"),
    [MOVE_TIME_SHIFT] = _("Time Shift"),
    [MOVE_WYVERN_SPEAR] = _("Wyvern Spr"),
    [MOVE_KAIROS_SPIRAL] = _("KairosSpiral"),
    [MOVE_SOLAR_FLARE] = _("Solar Flare"),
    [MOVE_ECHO_OF_AGES] = _("Echo Of Ages"),
    [MOVE_CRYSTALIZE] = _("Crystalize"),
    [MOVE_COIN_TOSS] = _("Coin Toss"),
    [MOVE_TORNADO_CRASH] = _("TornadoCrash"),
    [MOVE_HAUNTING] = _("Haunting"),
    [MOVE_PARADOX_WAVE] = _("Paradox Wave"),
    [MOVE_RIFT_RIPPER] = _("Rift Ripper"),
    [MOVE_RAPID_JAB] = _("Rapid Jab"),
