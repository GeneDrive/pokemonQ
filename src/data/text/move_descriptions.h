...
static const u8 sCaffeineBombDescription[] = _(
    "A strong drop of coffee\n"
    "that makes the target drowsy.");

static const u8 sTimeShiftDescription[] = _(
    "Strikes first by jumping through\n"
    "time at the foe.");

static const u8 sWyvernSpearDescription[] = _(
