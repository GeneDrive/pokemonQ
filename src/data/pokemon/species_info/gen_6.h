...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_STELLAR_COAT, ABILITY_NONE, ABILITY_BULLETPROOF },
        ...
        LEARNSETS(Chespin),
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_QUILLADIN}),
    },
    ...
    [SPECIES_QUILLADIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_GALVANIZE, ABILITY_NONE, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GREEN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_DECOMP_ODER, ABILITY_POISON_TOUCH, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_DROUGHT, ABILITY_ELECTRIC_SURGE, ABILITY_SOLAR_POWER },
...
#define PUMPKABOO_MISC_INFO                                                 \
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },          
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_STEELY_SPIRIT, ABILITY_MOLD_BREAKER },   
        .bodyColor = BODY_COLOR_BROWN,                                      
        .speciesName = _("Dartish"),                                       
        .natDexNum = NATIONAL_DEX_PUMPKABOO,                                
        .categoryName = _("Sharp fish"),                                       
        .frontAnimFrames = sAnims_Pumpkaboo,                                
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,                                 
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,                              
        PALETTES(Pumpkaboo),                                                
...
#define GOURGEIST_MISC_INFO                                                 \
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },          
        .abilities = { ABILITY_SHARPNESS, ABILITY_MOXIE, ABILITY_GALE_WINGS },   
        .bodyColor = BODY_COLOR_BROWN,                                      
        .speciesName = _("finedge"),                                      
        .natDexNum = NATIONAL_DEX_PUMPKABOO,                                
        .categoryName = _("Sharp fish"),                                       
    ...
    [SPECIES_GOURGEIST_SMALL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },          
        .abilities = { ABILITY_SHARPNESS, ABILITY_SURGE_SURFER, ABILITY_BATTERY },   
        .bodyColor = BODY_COLOR_BROWN,                                      
        .speciesName = _("finedge"),                                      
        .natDexNum = NATIONAL_DEX_PUMPKABOO,                                
        .categoryName = _("Sharp fish"),                                       
    ...
    [SPECIES_GOURGEIST_LARGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },          
        .abilities = { ABILITY_SHARPNESS, ABILITY_INTIMIDATE, ABILITY_SOUL_HEART },   
        .bodyColor = BODY_COLOR_BROWN,                                      
        .speciesName = _("finedge"),                                      
        .natDexNum = NATIONAL_DEX_PUMPKABOO,                                
        .categoryName = _("Sharp fish"),                                       
    ...
    [SPECIES_GOURGEIST_SUPER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },          
        .abilities = { ABILITY_SHARPNESS, ABILITY_BERSERK, ABILITY_MAGIC_BOUNCE },   
        .bodyColor = BODY_COLOR_BROWN,                                      
        .speciesName = _("finedge"),                                      
        .natDexNum = NATIONAL_DEX_PUMPKABOO,                                
        .categoryName = _("Sharp fish"),                                       
...
,
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
            ...
            .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        #endif
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_INFILTRATOR, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_PURPLE,
