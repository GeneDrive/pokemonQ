...
#define ORBEETLE_MISC_INFO                                                  \
    ...
    [SPECIES_NICKIT] =
    {
        ...
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_FILTER, ABILITY_EARLY_BIRD, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Yamask"),
        .cryId = CRY_YAMASK,
        .natDexNum = NATIONAL_DEX_NICKIT,
        .categoryName = _("Pilowspook"),
        .height = 6,
        .weight = 89,
        .description = COMPOUND_STRING(
        ...
        .trainerOffset = 0,
        .enemyMonElevation = 10,
        FRONT_PIC(Nickit, 48, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_Nickit,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        BACK_PIC(Nickit, 40, 40),
        .backPicYOffset = 14,
        ...
        LEARNSETS(Nickit),
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_DREAM_EATER, SPECIES_THIEVUL}),
    },
    ...
    [SPECIES_THIEVUL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_FILTER, ABILITY_EARLY_BIRD, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_WOOLOO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_CUD_CHEW, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Frosling"),
        .cryId = CRY_DUCKLETT,
        .natDexNum = NATIONAL_DEX_WOOLOO,
        .categoryName = _("ColdBirdling"),
        .height = 6,
        .weight = 60,
        .description = COMPOUND_STRING(
        ...
        LEARNSETS(Wooloo),
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DUBWOOL}),
    },
    ...
    [SPECIES_DUBWOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_CUD_CHEW, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_WHITE,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)  \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_ICE_SCALES, ABILITY_NONE, ABILITY_MARVEL_SCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Snom"),
        .cryId = CRY_SNOM,
