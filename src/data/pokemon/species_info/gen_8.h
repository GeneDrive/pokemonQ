...
#define ORBEETLE_MISC_INFO                                                  \
    ...
    [SPECIES_WOOLOO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_COMPOSURE, ABILITY_COMPOSURE, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Budraar"),
        .cryId = CRY_FLABEBE,
        .natDexNum = NATIONAL_DEX_WOOLOO,
        .categoryName = _("Ancient bud"),
        .height = 6,
        .weight = 60,
        .description = COMPOUND_STRING(
        ...
        LEARNSETS(Wooloo),
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_DUBWOOL}),
    },
