...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .expYield = 42,
        .evYield_Defense = 1,
        .genderRatio = PERCENT_FEMALE(33),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_EARTH_EATER, ABILITY_NONE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Obsidimite"),
        .cryId = CRY_TAROUNTULA,
        .natDexNum = NATIONAL_DEX_TAROUNTULA,
        .categoryName = _("Crystalarva"),
        .height = 3,
        .weight = 99,
        .description = COMPOUND_STRING(
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 13, SPECIES_SPIDOPS}),
    },
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_LIGHT_DEVOURER, ABILITY_NONE, ABILITY_LIGHT_DEVOURER },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Prizpod"),
        .cryId = CRY_SPIDOPS,
...
#define MAUSHOLD_SPECIES_INFO                                                           \
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .abilities = { ABILITY_MAGES_MIGHT, ABILITY_NONE, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("G'ning"),
        .cryId = CRY_VANILLITE,
    ...
    [SPECIES_DOLLIV] =
    {
        ...
        .abilities = { ABILITY_MAGES_MIGHT, ABILITY_NONE, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("G'noling"),
        .cryId = CRY_VANILLISH,
        .natDexNum = NATIONAL_DEX_DOLLIV,
        .categoryName = _("Gnomage"),
        .height = 6,
        .weight = 119,
        .description = COMPOUND_STRING(
