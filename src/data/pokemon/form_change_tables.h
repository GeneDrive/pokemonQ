...
static const struct FormChange sVenusaurFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_VENUSAUR_MEGA, MOVE_LEECH_SEED},
...
static const struct FormChange sCharizardFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_CHARIZARD_MEGA_X, MOVE_DRAGON_CLAW},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_CHARIZARD_MEGA_Y, MOVE_MORNING_SUN},
...
static const struct FormChange sBlastoiseFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_BLASTOISE_MEGA, MOVE_HYDRO_PUMP},
...
static const struct FormChange sBeedrillFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_BEEDRILL_MEGA, MOVE_FELL_STINGER},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sPidgeotFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_PIDGEOT_MEGA, MOVE_ZAP_CANNON},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sAlakazamFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_ALAKAZAM_MEGA, MOVE_PSYCHIC},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_FAMILY_ABRA
...
static const struct FormChange sSlowbroFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_SLOWBRO_MEGA, MOVE_SLACK_OFF},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGengarFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_GENGAR_MEGA, MOVE_LICK},
...
static const struct FormChange sSteelixFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_STEELIX_MEGA, MOVE_IRON_HEAD},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sScizorFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_SCIZOR_MEGA, MOVE_BULLET_PUNCH},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_GEN_2_CROSS_EVOS
...
static const struct FormChange sPinsirFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_PINSIR_MEGA, MOVE_SLASH},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGyaradosFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_GYARADOS_MEGA, MOVE_DRAGON_DANCE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sAerodactylFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_AERODACTYL_MEGA, MOVE_IRON_HEAD},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sAmpharosFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_AMPHAROS_MEGA, MOVE_DISCHARGE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sHeracrossFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_HERACROSS_MEGA, MOVE_PIN_MISSILE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sHoundoomFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_HOUNDOOM_MEGA, MOVE_COMEUPPANCE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sSceptileFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_SCEPTILE_MEGA, MOVE_DUAL_CHOP},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sSableyeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_SABLEYE_MEGA, MOVE_GRAVITY},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sMawileFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_MOVE,    SPECIES_MAWILE_MEGA, MOVE_PLAY_ROUGH},
    {FORM_CHANGE_TERMINATOR},
};
