static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 39, 18},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 18, 25},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 34, 31},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 13, 25},
    ...
    [HEAL_LOCATION_FALLARBOR_TOWN - 1] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), 11, 13},
    ...
    [HEAL_LOCATION_BINDING_CAVERN_1F - 1] = {MAP_GROUP(BINDING_CAVERN_1F), MAP_NUM(BINDING_CAVERN_1F), 32, 15},
    [HEAL_LOCATION_FUCK_OFF_CITY - 1] = {MAP_GROUP(FUCK_OFF_CITY), MAP_NUM(FUCK_OFF_CITY), 47, 83},
};
