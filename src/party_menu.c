...
const u16 sLevelCapFlags2[NUM_SOFT_CAPS] =
{
    ...
    FLAG_FRIGGIDFALLS_ARCHIE_EVENT_DONE, FLAG_ROUTE_105_HIDE_RIVALS, FLAG_BADGE02_GET, FLAG_BADGE03_GET, FLAG_BADGE04_GET,
    FLAG_BADGE05_GET, FLAG_BADGE06_GET, FLAG_BADGE07_GET, FLAG_BADGE08_GET,
};

const u16 sLevelCaps2[NUM_SOFT_CAPS] = { 8, 12, 16, 18, 24, 26, 28, 30, 40, 50, 60, 70, 80 };
