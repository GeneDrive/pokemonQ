...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Time
    ...
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(2.0), X(2.0)},
...
#endif
    [TYPE_FAIRY]    = {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, X(0.0)},
    [TYPE_TIME]     = {______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, ______, ______, X(2.0), X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______},
};
