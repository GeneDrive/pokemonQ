...
static const u8 sText_PkmnWentToSleep[] = _("{B_ATK_NAME_WITH_PREFIX} went into a\ndeep sleep!");
static const u8 sText_PkmnSleptHealthy[] = _("{B_ATK_NAME_WITH_PREFIX} went into a\n deep sleep and became healthy!");
...
static const u8 sText_SlowStartEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} started traveling\nthrough its past!");
static const u8 sText_SlowStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX} returned to\nto its past self!");
...
static const u8 sText_HospitalityRestoration[] = _("{B_ATK_PARTNER_NAME} was touched \nby {B_ATK_NAME_WITH_PREFIX}'s hospitality!");
