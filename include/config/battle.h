...
#define B_FLAG_NO_BAG_USE           0x278     // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          0x279     // If this flag is set, the ability to catch wild Pokémon is disabled.
